              ...
              info: (
                <InformationOverlay variant="critical">
                  <InformationOverlay.Content>
                    A "faulty version" is one that Dynatrace has determined to have introduced a bug and has since
                    revoked this version. It is recommended that you update immediately!
                  </InformationOverlay.Content>
                </InformationOverlay>
              ),
              name: "Faulty version:",
            ...
            },
            {
              info: (
                <InformationOverlay variant="warning">
                  <InformationOverlay.Content>
                    These OneAgents are over 1 year old and no longer supported by Dynatrace. The ability to autoupdate
                    from this version can no longer be guaranteed. It is recommended you update at the first available
                    window, and if necessary reinstall a newer version.
                  </InformationOverlay.Content>
                </InformationOverlay>
              ),
              name: "Unsupported:",
            ...
            },
            {
              info: (
                <InformationOverlay variant="primary">
                  <InformationOverlay.Content>
                    These OneAgents are over 6 months old. They are still supported, but updating soon is strongly
                    recommended. You are currently missing out on new features, more supported technologies, and the
                    latest bug fixes.
                  </InformationOverlay.Content>
                </InformationOverlay>
              ),
              name: "Older:",
              detail: (older.length > 0 && (
                <Button onClick={() => setAgentSpecialFilter("older")}>{older.length}</Button>
              )) || <> 0</>,
            },
          ],
    [isError, isLoading, faultyAgents, unsupported, older]
  );
